...
Version: August 2026 (rev. 18 Aug — master lodge template ship + `/themes/` R2 sync) · Custodian: Riaan Aggenbag, CEO · Marker: ASG-README-20260818-R5
...
- **Item 4 — currency binding.** Refines §8 lodge canon item 6: Pimcore holds base ZAR; on render, IP geolocation converts and **binds amount + currency symbol + currency code together** — never hardcode any of the three. Canonical switcher order **USD · GBP · EUR · AUD · MXN · ZAR** (live site currently AUD/ZAR/GBP/EUR/USD/MXN — web team to reorder). Mockup prices/symbols are placeholder snapshots only.
