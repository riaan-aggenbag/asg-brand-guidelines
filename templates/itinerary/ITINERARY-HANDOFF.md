...
| `itinerary_template.html` | The clean template. Every photo/logo is an `<img data-asset="key">` slot; no base64. This is the file a developer reads. | Repo: `templates/itinerary/itinerary_template.html` |
| `assets/*.png` (23) | Reference crops from the live itinerary screenshots + logo rasters cropped from the brand-book PDF. Placeholders only. | Repo: `templates/itinerary/assets/` |
| `build_itinerary.py` | Re-encodes assets and injects them into the template to produce the preview. `python3 build_itinerary.py` | Repo: `templates/itinerary/build_itinerary.py` |
| `ITINERARY-HANDOFF.md` | This document. | Repo: `templates/itinerary/` |
